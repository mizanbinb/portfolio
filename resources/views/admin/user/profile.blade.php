                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description" id="description" rows="5" class="form-control" placeholder="Write your profile description"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body text-center">
                                        <div style="height: 200px; width: 200px; overflow:hidden;" class="m-auto">
                                            <img src="" alt="" class="img-fluid rounded-circle img-rounded">
                                        </div>
                                        <div class="mt-2">
                                            <h5></h5>
                                            <p></p>
