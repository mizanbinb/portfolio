                                ...
                                <form action="{{ route('about.update', [$about->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="name" name="title" value="{{ $about->title }}" class="form-control" id="name" placeholder="Enter name">
                                        </div>
                                        <div class="form-group">
                                            <label for="name">Sub Title</label>
                                            <input type="name" name="sub_title" value="{{ $about->sub_title }}" class="form-control" id="name" placeholder="Enter name">
                                        </div>
                                        <div class="form-group">
